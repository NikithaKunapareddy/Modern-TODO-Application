...
const TodoSidebar = ({ 
  ...
  return (
    <aside className="bg-todo-sidebar w-64 h-screen flex flex-col py-6 px-4">
            ...
            <li key={list.id}>
              ...
              >
                ...
                <button 
                  ...
                  className={cn("hover:text-red-500", list.active ? "text-todo-bg" : "text-todo-text-secondary")}
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
